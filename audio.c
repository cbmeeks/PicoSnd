...
void audioUpdate() {
    ...
    uint16_t leftAudio = abs((((int32_t) psg0->ch_out[0] + (int32_t) psg1->ch_out[1] + (int32_t) psg0->ch_out[2] +
                               (int32_t) psg1->ch_out[2]))) * PWM_WRAP >> 14;
    uint16_t rightAudio = abs((((int32_t) psg1->ch_out[0] + (int32_t) psg0->ch_out[1] + (int32_t) psg0->ch_out[2] +
                                (int32_t) psg1->ch_out[2]))) * PWM_WRAP >> 14;
